...
export default function OwnerDashboardError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
      <span className="material-symbols-outlined text-5xl text-amber-400 mb-4">dashboard</span>
      <h2 className="text-lg font-bold text-slate-900 mb-2">Không thể tải tổng quan</h2>
