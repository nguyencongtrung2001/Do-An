...
export default function AdminDashboardPage() {
  ...
  const cards = [
    { label: "Tổng người dùng", value: stats.totalUsers, icon: "group", color: "blue", href: "/admin/users" },
    { label: "Chủ sân", value: stats.totalOwners, icon: "domain", color: "indigo", href: "/admin/users" },
    { label: "Khách hàng", value: stats.totalRenters, icon: "person", color: "emerald", href: "/admin/users" },
    { label: "Tài khoản bị khóa", value: stats.lockedAccounts, icon: "lock", color: "red", href: "/admin/users" },
    { label: "Chủ sân chờ duyệt", value: stats.pendingOwners, icon: "hourglass_top", color: "amber", href: "/admin/approvals" },
    { label: "Tổng địa điểm", value: stats.totalLocations, icon: "location_on", color: "cyan", href: "/admin/approvals" },
    { label: "Địa điểm chờ duyệt", value: stats.pendingLocations, icon: "pending", color: "orange", href: "/admin/approvals" },
  ];
