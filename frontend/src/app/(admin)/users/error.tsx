...
export default function AdminUsersError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 text-center">
      <span className="material-symbols-outlined text-5xl text-red-400 mb-4">group_off</span>
      <h2 className="text-lg font-bold text-slate-900 mb-2">Không thể tải danh sách người dùng</h2>
