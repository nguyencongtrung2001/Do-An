...
// Hàm helper đăng ký store trống để dùng cho useSyncExternalStore
...
export default function OwnerSidebar() {
  ...
  // NẾU CHƯA MOUNTED (Đang ở Server SSR): Render bộ xương tĩnh
  if (!isMounted) {
    return (
  ...
  // NẾU ĐÃ MOUNTED THÀNH CÔNG (Ở Browser Client)
  return (
    <>
      {/* Mobile Menu Button */}
      <button
