...
export class OwnerService {
    ...
    async CapNhatSan(userId, maSan, data, images) {
        const { ten_san, loai_the_thao, gia_thue_30p, trang_thai_san } = data;
    ...
    async LayLichDatCuaToi(userId) {
        return bookingRepository.TimTheoChuSan(userId);
    }
    async CapNhatTrangThaiDatSan(userId, bookingDetailId, status) {
    ...
    async LaySoLuongChoXuLy(userId) {
        return bookingRepository.DemChoXuLyTheoChuSan(userId);
    }
}
export const ownerService = new OwnerService();
//# sourceMappingURL=chusan.service.js.map