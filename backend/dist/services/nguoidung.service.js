...
export class UserService {
    ...
    async LayThongTinCaNhan(userId) {
    ...
    async CapNhatAnhDaiDien(userId, avatarUrl, cloudinaryId) {
...
//# sourceMappingURL=nguoidung.service.js.map