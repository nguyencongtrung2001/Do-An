...
export declare class OwnerService {
    DangKyChuSan(data: CreateOwner): Promise<{
        user: {
    ...
    LaySanCuaToi(userId: string): Promise<({
        anhsan: {
            ngay_tao: Date | null;
            ma_san: string | null;
            ma_anh_san: string;
    ...
    ThemSan(userId: string, data: any, images: {
        url: string;
        public_id: string;
    }[]): Promise<{
        ngay_tao: Date | null;
    ...
    CapNhatSan(userId: string, maSan: string, data: any, images?: {
        url: string;
        public_id: string;
    }[]): Promise<{
        ngay_tao: Date | null;
    ...
    XoaSan(userId: string, maSan: string): Promise<{
        ngay_tao: Date | null;
        ma_dia_diem: string | null;
        ma_san: string;
        ten_san: string;
    ...
    LayLichDatCuaToi(userId: string): Promise<({
        datsan: ({
            nguoidung: {
                ma_nguoi_dung: string;
                email: string;
    ...
    CapNhatTrangThaiDatSan(userId: string, bookingDetailId: string, status: string): Promise<{
        ma_san: string | null;
        ma_dat_san_chi_tiet: string;
        ma_dat_san: string | null;
        ngay_dat: Date;
    ...
    LaySoLuongChoXuLy(userId: string): Promise<number>;
}
export declare const ownerService: OwnerService;
//# sourceMappingURL=chusan.service.d.ts.map