export declare class CourtRepository {
    TimTheoDiaDiem(locationId: string): Promise<{
        ngay_tao: Date | null;
    ...
    TimTheoIdVaChuSan(courtId: string, userId: string): Promise<{
        ngay_tao: Date | null;
        ma_dia_diem: string | null;
        ma_san: string;
        ten_san: string;
    ...
    TimTheoId(courtId: string): Promise<{
        ngay_tao: Date | null;
        ma_dia_diem: string | null;
        ma_san: string;
        ten_san: string;
    ...
    TimAnhTheoSan(courtId: string): Promise<{
        ngay_tao: Date | null;
        ma_san: string | null;
        ma_anh_san: string;
    ...
    XoaAnhTheoSan(courtId: string): Promise<import("../generated/prisma/internal/prismaNamespace.js").BatchPayload>;
    TaoMoi(data: {
        ma_san: string;
        ma_dia_diem: string;
        ten_san: string;
    ...
    TaoMaSanTiepTheo(): Promise<string>;
    TaoMaAnhTiepTheo(): Promise<string>;
    TimDiaDiemTheoSlug(slug: string): Promise<({
        nguoidung: {
...
//# sourceMappingURL=san.repository.d.ts.map