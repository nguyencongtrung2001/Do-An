export declare class BookingRepository {
    ...
    TimTheoIdVaChuSan(bookingDetailId: string, userId: string): Promise<{
        ma_san: string | null;
        ma_dat_san_chi_tiet: string;
        ma_dat_san: string | null;
        ngay_dat: Date;
    ...
    CapNhatTrangThai(bookingDetailId: string, status: string): Promise<{
        ma_san: string | null;
        ma_dat_san_chi_tiet: string;
        ma_dat_san: string | null;
        ngay_dat: Date;
    ...
    DemChoXuLyTheoChuSan(userId: string): Promise<number>;
    KiemTraKhungGioTrong(slots: {
        ma_san: string;
        ngay_dat: Date;
        gio_bat_dau: Date;
        gio_ket_thuc: Date;
    ...
    TaoDonDatSan(bookingData: any, detailsData: any[], walletDeduction?: {
        userId: string;
        amount: number;
    }): Promise<{
        ma_nguoi_dung: string | null;
    ...
    TimTheoNguoiDung(userId: string): Promise<({
        datsanchitiet: ({
            san: ({
                diadiem: {
                    ma_nguoi_dung: string | null;
    ...
    HuyDonVaHoanTien(bookingId: string, userId: string, refundAmount: number): Promise<{
        success: boolean;
    }>;
}
export declare const bookingRepository: BookingRepository;
//# sourceMappingURL=datsan.repository.d.ts.map