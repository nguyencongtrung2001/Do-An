...
export class BookingRepository {
    ...
    async findByIdAndOwnerId(bookingDetailId, userId) {
    ...
    async checkSlotsAvailability(slots) {
    ...
    async createBooking(bookingData, detailsData, walletDeduction) {
