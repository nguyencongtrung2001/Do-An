...
export const getAverageRatingForLocation = async (req, res, next) => {
    try {
...
export const getAverageRatingForCourt = async (req, res, next) => {
    try {
...
export const getMyRatingForBooking = async (req, res, next) => {
    try {
        const ma_nguoi_dung = req.user?.id;
